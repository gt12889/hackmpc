...
// Spend overview (formerly the standalone Dashboard page). Now the "Spend"
// sub-tab of the consolidated Overview tab. Server component — fetches via the
// query layer and renders charts; secondary breakdowns stay behind an expand.
