  ...
  return (
    <div ref={rootRef} className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <div className="flex h-[min(560px,calc(100dvh-8rem))] w-[min(420px,calc(100vw-3rem))] flex-col overflow-hidden rounded-2xl border border-border/70 bg-background/95 shadow-2xl shadow-foreground/10 ring-1 ring-border/40 backdrop-blur-xl animate-fade-up">
          <div className="flex items-center justify-between border-b border-border/60 px-4 py-3">
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Talk to your spend data</p>
            </div>
            <button
              type="button"
      ...
      <button
        ...
        className={cn(
          "flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 transition-all hover:scale-105 hover:shadow-xl hover:shadow-primary/40",
          open && "rotate-0"
        )}
      >
