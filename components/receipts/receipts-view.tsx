      ...
      <div className="rounded-lg border border-border/60 p-4">
        ...
        >
          {busy ? (
            ...
            <>
              ...
              <div className="text-[13px] text-neutral-500">JPG / PNG · merchant, date, amount extracted automatically</div>
            </>
          )}
        ...
        {result && (
          <div className="mt-4 rounded-lg border border-border/60 bg-foreground/[0.02] p-3 text-sm">
            <div className="mb-2 flex items-center gap-2 text-[13px] uppercase tracking-wide text-neutral-500">
